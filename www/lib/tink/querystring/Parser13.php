...
class Parser13 extends ParserBase {
	/**
	...
	public function parse0 ($prefix) {
		...
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:194: characters 26-29
		$prefix2 = ($prefix === "" ? "fileToUpload" : ($prefix??'null') . ".fileToUpload");
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:217: lines 217-220
		$__o1 = (($this->exists->data[$prefix2] ?? null) ? $this->parse1($prefix2) : null);
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:194: characters 26-29
		$prefix3 = ($prefix === "" ? "id" : ($prefix??'null') . ".id");
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:217: lines 217-220
		$__o2 = (($this->exists->data[$prefix3] ?? null) ? FormField_Impl_::toInt(($this->params->data[$prefix3] ?? null)) : $this->missing($prefix3));
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:194: characters 26-29
		$prefix4 = ($prefix === "" ? "imgToUpload" : ($prefix??'null') . ".imgToUpload");
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:217: lines 217-220
		$__o3 = (($this->exists->data[$prefix4] ?? null) ? $this->parse1($prefix4) : null);
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:194: characters 26-29
		$prefix5 = ($prefix === "" ? "title" : ($prefix??'null') . ".title");
		...
		return new HxAnon([
			...
			"id" => $__o2,
			"imgToUpload" => $__o3,
			"title" => (($this->exists->data[$prefix5] ?? null) ? FormField_Impl_::toString(($this->params->data[$prefix5] ?? null)) : $this->missing($prefix5)),
		]);
	}
...
Boot::registerClass(Parser13::class, 'tink.querystring.Parser13');
