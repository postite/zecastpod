...
class Parser66 extends ParserBase {
	/**
	...
	public function parse0 ($prefix) {
		...
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:194: characters 26-29
		$prefix3 = ($prefix === "" ? "title" : ($prefix??'null') . ".title");
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:228: characters 7-10
		return new HxAnon([
			"desc" => $__o,
			"fileToUpload" => $__o1,
			"imgToUpload" => $__o2,
			"title" => (($this->exists->data[$prefix3] ?? null) ? FormField_Impl_::toString(($this->params->data[$prefix3] ?? null)) : $this->missing($prefix3)),
		]);
	}
...
Boot::registerClass(Parser66::class, 'tink.querystring.Parser66');
