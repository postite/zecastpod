...
class Parser68 extends ParserBase {
	/**
	...
	public function parse0 ($prefix) {
		...
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:194: characters 26-29
		$prefix3 = ($prefix === "" ? "imgToUpload" : ($prefix??'null') . ".imgToUpload");
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:217: lines 217-220
		$__o2 = (($this->exists->data[$prefix3] ?? null) ? $this->parse1($prefix3) : null);
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:194: characters 26-29
		$prefix4 = ($prefix === "" ? "title" : ($prefix??'null') . ".title");
		#/Users/ut/haxe/haxe_libraries/tink_querystring/0.6.0/haxelib/src/tink/querystring/macros/GenParser.hx:228: characters 7-10
		return new HxAnon([
			"desc" => $__o,
			"fileToUpload" => $__o1,
			"imgToUpload" => $__o2,
			"title" => (($this->exists->data[$prefix4] ?? null) ? FormField_Impl_::toString(($this->params->data[$prefix4] ?? null)) : $this->missing($prefix4)),
		]);
	}
...
Boot::registerClass(Parser68::class, 'tink.querystring.Parser68');
