...
class Router2 {
	...
	public function dbOne ($ctx) {
		#src/Server.hx:136: lines 136-139
		...
		switch ($_g1) {
			...
			case "multipart/form-data":
				...
				$tmp = Promise_Impl_::next($ctx->parse(), function ($pairs) {
					#src/Server.hx:94: lines 94-133
					return new SyncFuture(new LazyConst((new QuerystringParser2())->tryParse(Pairs_Impl_::ofIterable($pairs))));
				});
				break;
			default:
				#src/Server.hx:94: lines 94-133
				$tmp = Promise_Impl_::ofOutcome(Outcome::Failure(new TypedError(406, "Cannot process Content-Type " . ($_g1??'null'), new HxAnon([
					...
					"lineNumber" => 611,
					"className" => "tink.web.routing.Router2",
					"methodName" => "files",
				]))));
				break;
		}
					...
					case true:
						...
						switch ($_g4) {
							...
							case "dbone":
								#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
								if ($_g1 === false) {
									#src/Server.hx:135: characters 9-16
...
Boot::registerClass(Router2::class, 'tink.web.routing.Router2');
