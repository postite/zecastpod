...
use \tink\json\Parser60;
use \tink\querystring\Parser60 as QuerystringParser60;
		...
		switch ($_g1) {
			case "application/json":
				...
				$tmp = Promise_Impl_::next($ctx->allRaw(), function ($b) {
					#src/Server.hx:113: lines 113-142
					return new SyncFuture(new LazyConst((new Parser60())->tryParse($b->toString())));
				});
				break;
			...
			case "multipart/form-data":
				...
				$tmp = Promise_Impl_::next($ctx->parse(), function ($pairs) {
					#src/Server.hx:113: lines 113-142
					return new SyncFuture(new LazyConst((new QuerystringParser60())->tryParse(Pairs_Impl_::ofIterable($pairs))));
				});
				break;
			default:
				#src/Server.hx:113: lines 113-142
