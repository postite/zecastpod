...
class Router52 {
	...
	public function dbOne ($ctx) {
		#src/Server.hx:148: lines 148-151
		...
		switch ($_g1) {
			case "application/json":
				...
				$tmp = Promise_Impl_::next($ctx->allRaw(), function ($b) {
					#src/Server.hx:106: lines 106-145
					return new SyncFuture(new LazyConst((new Parser39())->tryParse($b->toString())));
				});
				break;
			...
			case "multipart/form-data":
				...
				$tmp = Promise_Impl_::next($ctx->parse(), function ($pairs) {
					#src/Server.hx:106: lines 106-145
					return new SyncFuture(new LazyConst((new QuerystringParser39())->tryParse(Pairs_Impl_::ofIterable($pairs))));
				});
				break;
			default:
				#src/Server.hx:106: lines 106-145
				$tmp = Promise_Impl_::ofOutcome(Outcome::Failure(new TypedError(406, "Cannot process Content-Type " . ($_g1??'null'), new HxAnon([
					...
					"lineNumber" => 611,
					"className" => "tink.web.routing.Router52",
					"methodName" => "files",
				]))));
				break;
		}
					...
					case true:
						...
						switch ($_g4) {
							...
							case "dbone":
								#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
								if ($_g1 === false) {
									#src/Server.hx:147: characters 9-16
			...
			case "POST":
				...
				if ($_g4 === "files") {
					...
					if ($_g2 === true) {
						#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
						if ($_g1 === false) {
							#src/Server.hx:105: characters 7-12
...
Boot::registerClass(Router52::class, 'tink.web.routing.Router52');
