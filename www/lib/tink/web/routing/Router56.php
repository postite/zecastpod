...
use \tink\querystring\Parser43 as QuerystringParser43;
...
class Router56 {
	...
	public function dbOne ($ctx) {
		#src/Server.hx:151: lines 151-154
		...
		switch ($_g1) {
			case "application/json":
				...
				$tmp = Promise_Impl_::next($ctx->allRaw(), function ($b) {
					#src/Server.hx:109: lines 109-148
					return new SyncFuture(new LazyConst((new Parser43())->tryParse($b->toString())));
				});
				break;
			...
			case "multipart/form-data":
				...
				$tmp = Promise_Impl_::next($ctx->parse(), function ($pairs) {
					#src/Server.hx:109: lines 109-148
					return new SyncFuture(new LazyConst((new QuerystringParser43())->tryParse(Pairs_Impl_::ofIterable($pairs))));
				});
				break;
			default:
				#src/Server.hx:109: lines 109-148
				$tmp = Promise_Impl_::ofOutcome(Outcome::Failure(new TypedError(406, "Cannot process Content-Type " . ($_g1??'null'), new HxAnon([
					...
					"lineNumber" => 611,
					"className" => "tink.web.routing.Router56",
					"methodName" => "files",
				]))));
				break;
		}
					...
					case true:
						...
						switch ($_g4) {
							...
							case "dbone":
								#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
								if ($_g1 === false) {
									#src/Server.hx:150: characters 9-16
							...
							case "pod":
								...
								if ($_g1 === true) {
									#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
									if ($_g === false) {
										#src/Server.hx:102: characters 11-21
							...
							case "up":
								...
								switch ($_g1) {
									case false:
										#src/Server.hx:95: characters 11-16
										return Promise_Impl_::ofSpecific($this->up($ctx, null));
										break;
									case true:
										#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
										if ($_g === false) {
											#src/Server.hx:96: characters 11-24
			...
			case "POST":
				...
				if ($_g4 === "files") {
					...
					if ($_g2 === true) {
						#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
						if ($_g1 === false) {
							#src/Server.hx:108: characters 7-12
...
Boot::registerClass(Router56::class, 'tink.web.routing.Router56');
