...
use \tink\querystring\Parser6 as QuerystringParser6;
		...
		switch ($_g1) {
			case "application/json":
				...
				$tmp = Promise_Impl_::next($ctx->allRaw(), function ($b) {
					#src/Server.hx:94: lines 94-139
					return new SyncFuture(new LazyConst((new Parser6())->tryParse($b->toString())));
				});
				break;
			...
			case "multipart/form-data":
				...
				$tmp = Promise_Impl_::next($ctx->parse(), function ($pairs) {
					#src/Server.hx:94: lines 94-139
					return new SyncFuture(new LazyConst((new QuerystringParser6())->tryParse(Pairs_Impl_::ofIterable($pairs))));
				});
				break;
			default:
				#src/Server.hx:94: lines 94-139
				$tmp = Promise_Impl_::ofOutcome(Outcome::Failure(new TypedError(406, "Cannot process Content-Type " . ($_g1??'null'), new HxAnon([
					...
					"lineNumber" => 611,
					"className" => "tink.web.routing.Router9",
					"methodName" => "files",
				]))));
				break;
		}
...
Boot::registerClass(Router9::class, 'tink.web.routing.Router9');
