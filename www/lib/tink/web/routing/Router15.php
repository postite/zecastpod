...
class Router15 {
	...
	public function dbOne ($ctx) {
		#src/Server.hx:142: lines 142-145
		...
		switch ($_g1) {
			...
			default:
				...
				$tmp = Promise_Impl_::ofOutcome(Outcome::Failure(new TypedError(406, "Cannot process Content-Type " . ($_g1??'null'), new HxAnon([
					...
					"lineNumber" => 611,
					"className" => "tink.web.routing.Router15",
					"methodName" => "files",
				]))));
				break;
		}
	...
	public function route ($ctx) {
		...
		switch ($ctx->request->header->method) {
			case "GET":
				...
				switch ($_g2) {
					case false:
						#src/Server.hx:46: characters 11-14
					...
					case true:
						...
						switch ($_g4) {
							case "cook":
								#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
								if ($_g1 === false) {
									#src/Server.hx:57: characters 11-18
							...
							case "dbone":
								#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
								if ($_g1 === false) {
									#src/Server.hx:141: characters 9-16
							...
							case "pod":
								...
								if ($_g1 === true) {
									#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
									if ($_g === false) {
										#src/Server.hx:85: characters 11-21
							...
							case "rss":
								#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
								if ($_g1 === false) {
									#src/Server.hx:70: characters 11-17
							...
							case "up":
								...
								switch ($_g1) {
									case false:
										#src/Server.hx:78: characters 11-16
							...
							case "viewrss":
								#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
								if ($_g1 === false) {
									#src/Server.hx:64: characters 12-22
			...
			case "POST":
				...
				if ($_g4 === "files") {
					...
					if ($_g2 === true) {
						#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
						if ($_g1 === false) {
							#src/Server.hx:93: characters 7-12
...
Boot::registerClass(Router15::class, 'tink.web.routing.Router15');
