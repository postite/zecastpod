...
use \tink\json\Parser71;
use \php\Boot;
use \tink\json\Parser72;
use \tink\core\TypedError;
use \tink\core\_Future\FutureObject;
use \tink\core\_Future\SyncFuture;
use \tink\querystring\Parser72 as QuerystringParser72;
use \tink\_Stringly\Stringly_Impl_;
use \tink\core\_Promise\Next_Impl_;
use \tink\querystring\Parser71 as QuerystringParser71;
...
class Router97 {
	...
	public function dbOne ($ctx) {
		#src/Server.hx:203: lines 203-206
		...
		switch ($_g1) {
			case "application/json":
				...
				$tmp = Promise_Impl_::next($ctx->allRaw(), function ($b) {
					#src/Server.hx:113: lines 113-142
					return new SyncFuture(new LazyConst((new Parser71())->tryParse($b->toString())));
				});
				break;
			...
			case "multipart/form-data":
				...
				$tmp = Promise_Impl_::next($ctx->parse(), function ($pairs) {
					#src/Server.hx:113: lines 113-142
					return new SyncFuture(new LazyConst((new QuerystringParser71())->tryParse(Pairs_Impl_::ofIterable($pairs))));
				});
				break;
			default:
				#src/Server.hx:113: lines 113-142
				$tmp = Promise_Impl_::ofOutcome(Outcome::Failure(new TypedError(406, "Cannot process Content-Type " . ($_g1??'null'), new HxAnon([
					...
					"lineNumber" => 611,
					"className" => "tink.web.routing.Router97",
					"methodName" => "files",
				]))));
				break;
		}
	...
	public function filesUpdate ($ctx) {
		...
		switch ($_g1) {
			case "application/json":
				...
				$tmp = Promise_Impl_::next($ctx->allRaw(), function ($b) {
					#src/Server.hx:145: lines 145-170
					return new SyncFuture(new LazyConst((new Parser72())->tryParse($b->toString())));
				});
				break;
			case "application/x-www-form-urlencoded":
			case "multipart/form-data":
				...
				$tmp = Promise_Impl_::next($ctx->parse(), function ($pairs) {
					#src/Server.hx:145: lines 145-170
					return new SyncFuture(new LazyConst((new QuerystringParser72())->tryParse(Pairs_Impl_::ofIterable($pairs))));
				});
				break;
			default:
				#src/Server.hx:145: lines 145-170
					...
					case true:
						...
						switch ($_g4) {
							...
							case "dbone":
								#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
								if ($_g1 === false) {
									#src/Server.hx:202: characters 9-16
...
Boot::registerClass(Router97::class, 'tink.web.routing.Router97');
