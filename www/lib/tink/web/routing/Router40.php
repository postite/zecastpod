...
use \tink\querystring\Parser28 as QuerystringParser28;
use \tink\_Stringly\Stringly_Impl_;
use \tink\json\Parser28;
		...
		switch ($_g1) {
			case "application/json":
				...
				$tmp = Promise_Impl_::next($ctx->allRaw(), function ($b) {
					#src/Server.hx:103: lines 103-142
					return new SyncFuture(new LazyConst((new Parser28())->tryParse($b->toString())));
				});
				break;
			...
			case "multipart/form-data":
				...
				$tmp = Promise_Impl_::next($ctx->parse(), function ($pairs) {
					#src/Server.hx:103: lines 103-142
					return new SyncFuture(new LazyConst((new QuerystringParser28())->tryParse(Pairs_Impl_::ofIterable($pairs))));
				});
				break;
			default:
				#src/Server.hx:103: lines 103-142
				$tmp = Promise_Impl_::ofOutcome(Outcome::Failure(new TypedError(406, "Cannot process Content-Type " . ($_g1??'null'), new HxAnon([
					...
					"lineNumber" => 611,
					"className" => "tink.web.routing.Router40",
					"methodName" => "files",
				]))));
				break;
		}
						...
						switch ($_g4) {
							...
							case "pod":
								...
								if ($_g1 === true) {
									#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
									if ($_g === false) {
										#src/Server.hx:94: characters 11-21
							...
							case "rss":
								#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
								if ($_g1 === false) {
									#src/Server.hx:79: characters 11-17
							...
							case "up":
								...
								switch ($_g1) {
									case false:
										#src/Server.hx:87: characters 11-16
										return Promise_Impl_::ofSpecific($this->up($ctx, null));
										break;
									case true:
										#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
										if ($_g === false) {
											#src/Server.hx:88: characters 11-24
			...
			case "POST":
				...
				if ($_g4 === "files") {
					...
					if ($_g2 === true) {
						#/Users/ut/haxe/haxe_libraries/tink_web/0.1.4/github/7c93ab66f476c97e62510c653bb4e58e918e1471/src/tink/web/macros/Routing.hx:143: characters 22-31
						if ($_g1 === false) {
							#src/Server.hx:102: characters 7-12
...
Boot::registerClass(Router40::class, 'tink.web.routing.Router40');
